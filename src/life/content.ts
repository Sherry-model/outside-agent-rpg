...
export interface LifeContent {
  version: '0.3.0' | '0.4.0'; capacity: number; voluntaryMinItems: number; recallWeight: number; outcomeWeight: number;
...
export function configFor(version: LifeContent['version']): LifeContent { return version==='0.3.0' ? legacyConfig : config; }
...
export function contentFor(version: LifeContent['version']): Content { return version==='0.3.0' ? legacyContent : cognitionContent; }
